...
\begin{eq}
	G_M^{\,O_1\cdots O_n}(\tau_1,\ldots, \tau_n):=-\langle\tp_\tau[O_1^{H}(\tau_1) \cdots O_n^{H}(\tau_n)]\rangle_\beta
\end{eq}
...
\begin{eq}\label{eq:matsu_GF_PI}
	\langle\tp[a_{\alpha_1}(\tau_1)\ldots a_{\alpha_n}(\tau_n)a_{\alpha_{n+1}}^\dagger(\tau_{n+1})\ldots a_{\alpha_{2n}}^\dagger(\tau_{2n})]\rangle_\beta
	:= \frac%
...
then
\begin{eq}
	&\langle\tp[a_{\alpha_1}(\tau_1)\cdots a_{\alpha_n}a_{\alpha_{n+1}}^\dagger\cdots a_{\alpha_{2n}}]\rangle_\beta=\\
