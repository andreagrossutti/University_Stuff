...
\begin{eq}\label{eq:Zsc}
	Z_{\text{s.c.}}\approx\sum_{N=0}^\infty\sum_{\{\Gamma_1,\ldots,\Gamma_N\}}e^{\displaystyle-S(\Gamma_{1},\ldots,\Gamma_{N})}
\end{eq}
