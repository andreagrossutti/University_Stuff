...
\end{tikzpicture}
\caption{The sites of the lattice are denoted by $+$ and $-$ depending on wether the field has positive or negative value on them. The blue lines represent defects which are supported in the dual lattice and are constructed according to fig.~\ref{fig:defect-lattice-1}.}
