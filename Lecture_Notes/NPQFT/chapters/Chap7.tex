...
\begin{eq}
	\sum_n e^{-\frac\lambda2\int(\partial_\mu\Lambda+A_\mu+2\pi n_\mu)^2}=\sum_je^{-\frac1{2\lambda}\int j_\mu^2}e^{i\int(\partial_\mu\Lambda-A_\mu)j^\mu}
\end{eq}
...
\begin{eq}
	Z_\lambda&=\int\pide A_\mu\sum_{n_\mu}\,e^{-\frac1{2e^2}\int(\partial_{[\mu}A_{\nu]})^2}e^{-\frac\lambda2\int(\partial_\mu\Lambda-A_\mu+2\pi n_\mu)^2}\delta(\partial^\mu A_\mu)\\
	&=\int\pide A_\mu^T\int\pide\Lambda\sum_{j_\mu}\,e^{-\frac1{2e^2}\int(\partial_{[\mu}A_{\nu]}^T)^2}\,e^{-\frac1{2\lambda}\int j_\mu^2}e^{i\int (-A_\mu^T+\partial_\mu\Lambda) j^\mu}\\
	&=\int\pide A_\mu^T\,e^{-\frac1{2e^2}\int(\partial_{[\mu}A_{\nu]}^T)^2}\,e^{-\frac1{2\lambda}\int (\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma})^2}e^{-i\int A^\mu_T\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma}}\\
	&=\int\pide A_\mu\,e^{-\frac1{2e^2}\int(\partial_{[\mu}A_{\nu]})^2}\,e^{-\frac1{2\lambda}\int (\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma})^2}e^{-i\int A^\mu\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma}}\delta(\partial^\mu A_\mu)\\
\end{eq}
Applying then the duality procedure as in eq.~\eqref{eq:duality-free-photon} we have 
\begin{eq}
	Z_\lambda&=\int\pide A_\mu^T\int\pide B_{\mu\nu}\sum_{S^{\rho\sigma}}\,e^{-\frac{e^2}2\int B_{\mu\nu}^2}e^{i\int B_{\mu\nu}\partial^\mu A^\nu_T}e^{-\frac1{2\lambda}\int(\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma})^2}e^{-i\int A^\mu_T\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma}}
\end{eq}
...
so that 
\begin{eq}
	Z_\infty&=\int\pide \tilde A^\mu\sum_{S^{\rho\sigma}}e^{-\frac{e^2}2\int(\lctens_{\mu\nu\rho\sigma}(\partial^\rho\tilde A^\sigma+S^{\rho\sigma}))^2}\delta(\partial^\mu\tilde A_\mu)\\
	&=\int\pide\tilde A_\mu\sum_{S^{\rho\sigma}}e^{-\frac{e^2}2\int(\partial^{[\rho}\tilde A^{\sigma]}+S^{\rho\sigma})^2}\delta(\partial^\mu\tilde A_\mu)
\end{eq}
...
\begin{eq}
	\lctens_{\mu\nu\rho\sigma}\partial^\nu\tilde{\mathcal F}^{\rho\sigma}=\lctens_{\mu\nu\rho\sigma}\partial^\nu\partial^{[\rho}\tilde A^{\sigma]}+\lctens_{\mu\nu\rho\sigma}\partial^\nu S^{\rho\sigma}=j_\mu
\end{eq}
...
\begin{eq}\label{eq:monop-correlat-lambda-infty}
	...
	&\qquad=\frac1Z\int\pide A_\mu\,e^{-\frac1{2e^2}\int(\partial_{[\mu}A_{\nu]})^2}\delta(\partial^\mu A_\mu)\sum_{j_\mu\,:\,\partial^\mu j_\mu=\delta_x-\delta_y}e^{i\int A_\mu(-j_\mu+E_\mu^x-E_\mu^y)}=\\
	&\qquad=\frac1Z\int\pide A_\mu\,e^{-\frac1{2e^2}\int(\partial_{[\mu}A_{\nu]})^2}\delta(\partial^\mu A_\mu)\sum_{j_\mu\,:\,\partial^\mu j_\mu=0}e^{i\int A_\mu(-j_\mu+j_\mu^{xy}+E_\mu^x-E_\mu^y)}\\
\end{eq}
...
\draw [shift={(215.49,151.69)}, rotate = 445.45] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.45,-5.02) -- (0,0) -- (10.45,5.02) -- cycle    ;
%Straight Lines [id:da9536377690303859] 
\draw    (230,57.5) -- (309,89.33) ;
\draw [shift={(269.5,73.42)}, rotate = 201.95] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da5956258746113772] 
\draw    (230,57.5) -- (309,12) ;
\draw [shift={(269.5,34.75)}, rotate = 510.06] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da40651481967876824] 
\draw    (141,42.67) -- (230,57.5) ;
\draw [shift={(185.5,50.08)}, rotate = 9.46] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da20641993760547628] 
\draw    (178.33,6) -- (230,57.5) ;
\draw [shift={(204.17,31.75)}, rotate = 44.91] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da12391154990815179] 
\draw    (157.67,89.33) -- (230,57.5) ;
\draw [shift={(193.83,73.42)}, rotate = 336.25] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da21526296373902576] 
\draw    (230,57.5) -- (315.67,56) ;
\draw [shift={(272.83,56.75)}, rotate = 539] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da8937832289395333] 
\draw    (230,57.5) -- (272.33,111.33) ;
\draw [shift={(251.17,84.42)}, rotate = 231.82] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da9575622782574718] 
\draw    (215.33,247.83) -- (294.33,279.67) ;
\draw [shift={(254.83,263.75)}, rotate = 21.95] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da6034055373922615] 
\draw    (215.33,247.83) -- (294.33,202.33) ;
\draw [shift={(254.83,225.08)}, rotate = 330.06] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da15166429129257053] 
\draw    (126.33,233) -- (215.33,247.83) ;
\draw [shift={(170.83,240.42)}, rotate = 189.46] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da3975888310879898] 
\draw    (163.67,196.33) -- (215.33,247.83) ;
\draw [shift={(189.5,222.08)}, rotate = 224.91] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da004602224665434473] 
\draw    (143,279.67) -- (215.33,247.83) ;
\draw [shift={(179.17,263.75)}, rotate = 516.25] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da6747402885776581] 
\draw    (215.33,247.83) -- (301,246.33) ;
\draw [shift={(258.17,247.08)}, rotate = 359] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da7626517334341056] 
\draw    (215.33,247.83) -- (257.67,301.67) ;
\draw [shift={(236.5,274.75)}, rotate = 51.82] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
...
\draw [shift={(426,106.67)}, rotate = 534.77] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.45,-5.02) -- (0,0) -- (10.45,5.02) -- cycle    ;
...
\end{tikzpicture}
%
\caption{One dimensionless representation of currents and fields in eq.~\eqref{eq:monop-correlat-lambda-infty}.}
...
\begin{eq}
	...
	&=\int\de^4w\,\partial_\mu\Delta^{-1}(z-w)\cancel{\partial^\beta(j^{xy}+E^x-E^y)_\beta(w)}-\\
...
\begin{eq}
	\langle M(x)M(y)\rangle=\bra0\op M(\vec x)e^{-H(x^0-y^0)}\op M^\dagger(\vec y)\ket0
\end{eq}
...
\draw [shift={(142.93,142)}, rotate = 445.15] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.45,-5.02) -- (0,0) -- (10.45,5.02) -- cycle    ;
%Straight Lines [id:da23152433957140084] 
\draw    (155.4,65.07) -- (223.27,91.07) ;
\draw [shift={(189.34,78.07)}, rotate = 200.96] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da7521717768429035] 
\draw    (155.4,65.07) -- (223.27,27.9) ;
\draw [shift={(189.34,46.48)}, rotate = 511.3] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da3813203099802065] 
\draw    (78.93,52.95) -- (155.4,65.07) ;
\draw [shift={(117.17,59.01)}, rotate = 9] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da7123700488843085] 
\draw    (111.01,23) -- (155.4,65.07) ;
\draw [shift={(133.2,44.03)}, rotate = 43.46] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da03896854735361477] 
\draw    (93.25,91.07) -- (155.4,65.07) ;
\draw [shift={(124.33,78.07)}, rotate = 337.3] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da9329409978551189] 
\draw    (155.4,65.07) -- (229,63.84) ;
\draw [shift={(192.2,64.45)}, rotate = 539.05] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da610320029346342] 
\draw    (155.4,65.07) -- (191.77,109.04) ;
\draw [shift={(173.58,87.05)}, rotate = 230.4] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da7334778053588917] 
\draw    (142.8,220.53) -- (210.67,246.53) ;
\draw [shift={(176.73,233.53)}, rotate = 20.96] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da9378344826057308] 
\draw    (142.8,220.53) -- (210.67,183.36) ;
\draw [shift={(176.73,201.95)}, rotate = 331.3] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da9881097931142797] 
\draw    (66.33,208.41) -- (142.8,220.53) ;
\draw [shift={(104.57,214.47)}, rotate = 189] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da4582833618389974] 
\draw    (98.41,178.46) -- (142.8,220.53) ;
\draw [shift={(120.6,199.5)}, rotate = 223.46] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da8348848056585603] 
\draw    (80.65,246.53) -- (142.8,220.53) ;
\draw [shift={(111.73,233.53)}, rotate = 517.3] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da08880361463986741] 
\draw    (142.8,220.53) -- (216.4,219.3) ;
\draw [shift={(179.6,219.92)}, rotate = 359.05] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
%Straight Lines [id:da8383003573879682] 
\draw    (142.8,220.53) -- (179.17,264.5) ;
\draw [shift={(160.98,242.51)}, rotate = 50.4] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (6.25,-3) -- (0,0) -- (6.25,3) -- cycle    ;
...
\draw [shift={(475.4,65.54)}, rotate = 291.77] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 3.92, y radius= 3.92]   ;
\draw [shift={(462.93,142.47)}, rotate = 445.15] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.45,-5.02) -- (0,0) -- (10.45,5.02) -- cycle    ;
\draw [shift={(462.8,221)}, rotate = 283.38] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 3.92, y radius= 3.92]   ;
...
\draw [shift={(84,244.68)}, rotate = 115.24] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(196.41,6.19)}, rotate = 115.24] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da2094013016890539] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (197.28,8.37) -- (253.8,149.83) ;
\draw [shift={(254.67,152.01)}, rotate = 68.22] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(196.41,6.19)}, rotate = 68.22] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da22391521746858856] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (278.36,295.39) -- (197.05,8.45) ;
\draw [shift={(196.41,6.19)}, rotate = 254.18] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(279,297.65)}, rotate = 254.18] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da7440698596174549] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (196.42,8.54) -- (197.05,149.01) ;
\draw [shift={(197.06,151.36)}, rotate = 89.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(196.41,6.19)}, rotate = 89.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da12830230249803742] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (195.25,152.85) -- (85.81,243.18) ;
\draw [shift={(84,244.68)}, rotate = 140.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(197.06,151.36)}, rotate = 140.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da10677579926867731] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (198.21,153.41) -- (277.85,295.6) ;
\draw [shift={(279,297.65)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(197.06,151.36)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da08291812818968824] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (199.41,151.38) -- (252.32,151.98) ;
\draw [shift={(254.67,152.01)}, rotate = 0.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(197.06,151.36)}, rotate = 0.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da8215533424387143] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (86.27,245.3) -- (276.73,297.04) ;
\draw [shift={(279,297.65)}, rotate = 15.2] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(84,244.68)}, rotate = 15.2] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da32221379808607975] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (86.07,243.56) -- (252.6,153.13) ;
\draw [shift={(254.67,152.01)}, rotate = 331.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(84,244.68)}, rotate = 331.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9880502250610932] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (255.06,154.33) -- (278.61,295.33) ;
\draw [shift={(279,297.65)}, rotate = 80.52] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(254.67,152.01)}, rotate = 80.52] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Shape: Circle [id:dp4408572844254719] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (208.75,177.7) .. controls (208.75,175.91) and (210.21,174.45) .. (212,174.45) .. controls (213.79,174.45) and (215.25,175.91) .. (215.25,177.7) .. controls (215.25,179.49) and (213.79,180.95) .. (212,180.95) .. controls (210.21,180.95) and (208.75,179.49) .. (208.75,177.7) -- cycle ;
%Shape: Circle [id:dp8591579522801442] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (237.7,151.92) .. controls (237.7,150.13) and (239.16,148.67) .. (240.95,148.67) .. controls (242.75,148.67) and (244.2,150.13) .. (244.2,151.92) .. controls (244.2,153.72) and (242.75,155.17) .. (240.95,155.17) .. controls (239.16,155.17) and (237.7,153.72) .. (237.7,151.92) -- cycle ;
%Shape: Circle [id:dp9270340091397358] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (193.25,35.4) .. controls (193.25,33.61) and (194.71,32.15) .. (196.5,32.15) .. controls (198.29,32.15) and (199.75,33.61) .. (199.75,35.4) .. controls (199.75,37.19) and (198.29,38.65) .. (196.5,38.65) .. controls (194.71,38.65) and (193.25,37.19) .. (193.25,35.4) -- cycle ;
%Shape: Circle [id:dp42417247389203117] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (172.85,168.4) .. controls (172.85,166.61) and (174.31,165.15) .. (176.1,165.15) .. controls (177.89,165.15) and (179.35,166.61) .. (179.35,168.4) .. controls (179.35,170.19) and (177.89,171.65) .. (176.1,171.65) .. controls (174.31,171.65) and (172.85,170.19) .. (172.85,168.4) -- cycle ;
%Straight Lines [id:da7591368397307141] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (462.4,7.66) -- (352,241.9) ;
\draw [shift={(351,244.03)}, rotate = 115.24] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(463.41,5.54)}, rotate = 115.24] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da3444542785016118] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (464.28,7.72) -- (520.8,149.18) ;
\draw [shift={(521.67,151.36)}, rotate = 68.22] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(463.41,5.54)}, rotate = 68.22] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da3886783094945634] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (545.36,294.74) -- (464.05,7.8) ;
\draw [shift={(463.41,5.54)}, rotate = 254.18] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(546,297)}, rotate = 254.18] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da295775823341778] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (463.42,7.89) -- (464.05,148.35) ;
\draw [shift={(464.06,150.7)}, rotate = 89.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(463.73,78.12)}, rotate = 89.74] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
\draw [shift={(463.41,5.54)}, rotate = 89.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da7853830909468005] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (462.25,152.2) -- (352.81,242.53) ;
\draw [shift={(351,244.03)}, rotate = 140.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(407.53,197.37)}, rotate = 140.46] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
\draw [shift={(464.06,150.7)}, rotate = 140.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da027134956928842158] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (465.21,152.75) -- (544.85,294.95) ;
\draw [shift={(546,297)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(505.03,223.85)}, rotate = 60.75] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
\draw [shift={(464.06,150.7)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da17976783307978605] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (466.41,150.73) -- (519.32,151.33) ;
\draw [shift={(521.67,151.36)}, rotate = 0.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(492.87,151.03)}, rotate = 180.65] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
\draw [shift={(464.06,150.7)}, rotate = 0.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9878093991830288] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (353.27,244.64) -- (543.73,296.38) ;
\draw [shift={(546,297)}, rotate = 15.2] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(351,244.03)}, rotate = 15.2] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da3384465595014927] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (353.07,242.91) -- (519.6,152.48) ;
\draw [shift={(521.67,151.36)}, rotate = 331.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(351,244.03)}, rotate = 331.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9910775832584819] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (522.06,153.68) -- (545.61,294.68) ;
\draw [shift={(546,297)}, rotate = 80.52] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(521.67,151.36)}, rotate = 80.52] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;

\draw [shift={(280.86,31.14)}, rotate = 68.22] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(280.86,71.14)}, rotate = 68.22] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] [line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw [shift={(175.89,114.47)}, rotate = 89.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 5.23, y radius= 5.23]   ;
\draw [shift={(175.58,43.77)}, rotate = 89.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 5.23, y radius= 5.23]   ;
%Straight Lines [id:da6738627227445009] 
\draw [line width=1.5]    (196.39,151.94) -- (217.57,152.18) ;
\draw [shift={(217.57,152.18)}, rotate = 0.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 5.23, y radius= 5.23]   ;
\draw [shift={(192.16,151.89)}, rotate = 0.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 5.23, y radius= 5.23]   ;
%Straight Lines [id:da5182178087232998] 
\draw [line width=1.5]    (149.33,173.77) -- (92.99,220.27) ;
\draw [shift={(89.73,222.97)}, rotate = 140.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 5.23, y radius= 5.23]   ;
\draw [shift={(149.33,173.77)}, rotate = 140.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 5.23, y radius= 5.23]   ;
%Straight Lines [id:da04996416143259297] 
\draw [line width=1.5]    (194.23,184.15) -- (238.19,262.63) ;
\draw [shift={(239.83,265.55)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 4.36, y radius= 4.36]   ;
\draw [shift={(194.23,184.15)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 4.36, y radius= 4.36]   ;
...
\draw [shift={(217.2,23.2)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 4.36, y radius= 4.36]   ;
\draw [shift={(217.2,65.2)}, rotate = 60.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=1.5]      (0, 0) circle [x radius= 4.36, y radius= 4.36]   ;
...
\draw [shift={(108.14,140.1)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
...
\draw [shift={(287.34,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
...
\draw [shift={(332.51,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
%Straight Lines [id:da14801558177916063] 
\draw [line width=1.5]    (353.99,140.08) -- (373.68,140.08) ;
\draw [shift={(377.68,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
%Straight Lines [id:da7637986970069108] 
\draw [line width=1.5]    (399.16,140.08) -- (418.84,140.08) ;
\draw [shift={(422.84,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
%Straight Lines [id:da5140113640305328] 
\draw [line width=1.5]    (444.32,140.08) -- (464.01,140.08) ;
\draw [shift={(468.01,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
%Straight Lines [id:da13967326849119188] 
\draw [line width=1.5]    (489.49,140.08) -- (509.18,140.08) ;
\draw [shift={(513.18,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
%Straight Lines [id:da5971180607342266] 
\draw [line width=1.5]    (534.66,140.08) -- (554.34,140.08) ;
\draw [shift={(558.34,140.08)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
%Shape: Circle [id:dp441711292376024] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (227.37,140.08) .. controls (227.37,138.44) and (228.69,137.12) .. (230.33,137.12) .. controls (231.97,137.12) and (233.3,138.44) .. (233.3,140.08) .. controls (233.3,141.72) and (231.97,143.05) .. (230.33,143.05) .. controls (228.69,143.05) and (227.37,141.72) .. (227.37,140.08) -- cycle ;
%Shape: Circle [id:dp22948531046480758] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (588.7,140.08) .. controls (588.7,138.44) and (590.03,137.12) .. (591.67,137.12) .. controls (593.31,137.12) and (594.63,138.44) .. (594.63,140.08) .. controls (594.63,141.72) and (593.31,143.05) .. (591.67,143.05) .. controls (590.03,143.05) and (588.7,141.72) .. (588.7,140.08) -- cycle ;
...
\caption{On the left, the two triangles represent two close tetrahedrons, and the arrow represent a spin flip in the spin shared between them. On the right, we have the representation of a chain of spin flips, chosen so that it represent a ``Dirac string'' whose boundaries constitute a ``monopole-antimonopole pair''. }
